...
RSpec.describe "as a registered user", type: :request do
  ...
  it "I can see all the active parts in the system" do
    ...
    rp1 = ResourcePart.create(resource_id: 1, part_id: 1)
    rp2 = ResourcePart.create(resource_id: 1, part_id: 2)
    rp3 = ResourcePart.create(resource_id: 1, part_id: 3)

    get "/api/v1/resources/1/parts"
